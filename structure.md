...
The `<extension acronym>` in the URLs above is the acronym of the extension as defined in the related SKG-IF GitHub repository assigned with the extension, without considering the prefix `ext-`. For instance, the current ontology for this extension is accessible at the URL [https://w3id.org/skg-if/extension/srv/ontology/](https://w3id.org/skg-if/extension/srv/ontology/).

Instead, `<X.Y.Z>` in the URLs above identifies the version number of the particular context developed for the extension. For instance, the ontology having version `1.0.0` for this extension is accessible at the URL [https://w3id.org/skg-if/extension/srv/ontology/1.0.0/](https://w3id.org/skg-if/extension/srv/ontology/1.0.0/).
...
The `<extension acronym>` in the URLs above is the acronym of the extension as defined in the related SKG-IF GitHub repository assigned with the extension, without considering the prefix `ext-`. For instance, the current context for this extension is accessible at the URL [https://w3id.org/skg-if/extension/srv/context/skg-if.json](https://w3id.org/skg-if/extension/srv/context/skg-if.json).

Instead, `<X.Y.Z>` in the URLs above identifies the version number of the particular context developed for the extension. For instance, the context having version `1.0.0` for this extension is accessible at the URL [https://w3id.org/skg-if/extension/srv/context/1.0.0/skg-if.json](https://w3id.org/skg-if/extension/srv/context/1.0.0/skg-if.json).
